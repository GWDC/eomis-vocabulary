...
@RestController
@RequestMapping("/api/eomis-vocabulary-kafka")
public class EomisVocabularyKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EomisVocabularyKafkaResource.class);
    ...
    public EomisVocabularyKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
